...
const Navbar = () => {
  const [isOpen, setIsOpen] = useState(false); // React state for menu toggle
    ...
    <nav className="relative bg-white shadow dark:bg-gray-800">
      <div className="container px-6 py-3 mx-auto md:flex">
        ...
        >
          ...
          <button className="px-2.5 py-2 text-gray-100 transition-colors duration-300 transform rounded-lg  md:mx-2 bg-green-600 hover:bg-green-500">
            Sign In
          </button>
        </div>
      </div>
